module "terraform-vm" {
  source               = "github.com/PacktPublishing/Hashicorp-Infrastructure-Automation-Terraform-Associate-Exam-Guide.git//chapter7/azurerm/azurerm-virtual-machine?ref=v0.0.1"
  rgname               = var.rgname
